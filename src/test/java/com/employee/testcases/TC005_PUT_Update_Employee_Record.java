...
public class TC005_PUT_Update_Employee_Record extends TestBaseClass {
	ReadConfig readConfig = new ReadConfig();

	@SuppressWarnings("unchecked")
	@Test(dataProvider = "empdataprovider", priority = -1)
	void postemployee(String ename, String Esalary, String eAGE) {
		logger.info("$$ Started TC005 Update Employee Record $$");
	...
	@AfterClass
	void teardown() {
		logger.info("$$ Finished TC003 Update Employee Record $$");
	}
}
